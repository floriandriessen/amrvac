...
111   close(unitpar)
  ...
  subroutine fields_from_mhd(igrid, w_mhd, w_part)
    ...
    case (cylindrical)
      w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ep(r_)) = w_part(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,bp(phi_)) * w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         iw_mom(z_)) - w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         bp(z_)) * w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         iw_mom(phi_)) + particles_eta * current(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         r_)
      w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ep(phi_)) = w_part(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,bp(z_)) * w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         iw_mom(r_)) - w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         bp(r_)) * w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         iw_mom(z_)) + particles_eta * current(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         phi_)
      w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ep(z_)) = w_part(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,bp(r_)) * w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         iw_mom(phi_)) - w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         bp(phi_)) * w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         iw_mom(r_)) + particles_eta * current(ixGlo1:ixGhi1,ixGlo2:ixGhi2,z_)
    end select
    ...
    if (particles_etah > zero) then
      ...
      case (cylindrical)
        w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ep(r_)) = w_part(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,ep(r_)) + particles_etah/w(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,iw_rho) * (current(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           phi_) * w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           bp(z_)) - current(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           z_) * w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,bp(phi_)))
        w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ep(phi_)) = w_part(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,ep(phi_)) + particles_etah/w(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,iw_rho) * (-current(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           r_) * w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           bp(z_)) + current(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           z_) * w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,bp(r_)))
        w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ep(z_)) = w_part(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,ep(z_)) + particles_etah/w(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,iw_rho) * (current(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           r_) * w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           bp(phi_)) - current(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           phi_) * w_part(ixGlo1:ixGhi1,ixGlo2:ixGhi2,bp(r_)))
      end select
    end if
  ...
  subroutine handle_particles()
    ...
    do
      if (tmax_particles >= t_next_output) then
        ...
        if (mype .eq. 0 .and. (.not. time_advance)) print*,&
            "Writing particle output at time",t_next_output
...
!        call write_particle_output()
  ...
  subroutine interpolate_var(igrid,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
    ...
    double precision                      :: xd1,xd2, myq, dx1
    ...
    if(stretch_type(1)==stretch_uni) then
      ...
      ic1 = ceiling(dlog((xloc(1)-xprobmin1)*(qstretch(ps(igrid)%level,&
         1)-one)/dxfirst(ps(igrid)%level,1)+one)/dlog(qstretch(ps(igrid)%level,&
         1)))-(node(pig1_,igrid)-1)*block_nx1+nghostcells
    else if(stretch_type(1)==stretch_symm) then
      ! symmetric stretch about 0.5*(xprobmin+xprobmax)
      if(xloc(1)<xprobmin1+xstretch1) then
        ! stretch to left from xprobmin+xstretch
        ic1 = block_nx1-(int(dlog((xprobmin1+&
           xstretch1-xloc(1))*(qstretch(ps(igrid)%level,&
           1)-one)/dxfirst(ps(igrid)%level,&
           1)+one)/dlog(qstretch(ps(igrid)%level,1)))-(nstretchedblocks(level,&
           1)/2-node(pig1_,igrid))*block_nx1)+nghostcells
      else if(xloc(1)>xprobmax1-xstretch1) then
        ! stretch to right from xprobmax-xstretch
        ic1 = ceiling(dlog((xloc(1)-xprobmax1+&
           xstretch1)*(qstretch(ps(igrid)%level,&
           1)-one)/dxfirst(ps(igrid)%level,&
           1)+one)/dlog(qstretch(ps(igrid)%level,1)))-((node(pig1_,&
           igrid)-1+nstretchedblocks(level,&
           1)/2)*block_nx1-domain_nx1*2**(ps(igrid)%level-one))+nghostcells
      else
    ...
    if(stretch_type(2)==stretch_uni) then
      ...
      ic2 = ceiling(dlog((xloc(2)-xprobmin2)*(qstretch(ps(igrid)%level,&
         2)-one)/dxfirst(ps(igrid)%level,2)+one)/dlog(qstretch(ps(igrid)%level,&
         2)))-(node(pig2_,igrid)-1)*block_nx2+nghostcells
    else if(stretch_type(2)==stretch_symm) then
      ! symmetric stretch about 0.5*(xprobmin+xprobmax)
      if(xloc(2)<xprobmin2+xstretch2) then
        ! stretch to left from xprobmin+xstretch
        ic2 = block_nx2-(int(dlog((xprobmin2+&
           xstretch2-xloc(2))*(qstretch(ps(igrid)%level,&
           2)-one)/dxfirst(ps(igrid)%level,&
           2)+one)/dlog(qstretch(ps(igrid)%level,2)))-(nstretchedblocks(level,&
           2)/2-node(pig2_,igrid))*block_nx2)+nghostcells
      else if(xloc(2)>xprobmax2-xstretch2) then
        ! stretch to right from xprobmax-xstretch
        ic2 = ceiling(dlog((xloc(2)-xprobmax2+&
           xstretch2)*(qstretch(ps(igrid)%level,&
           2)-one)/dxfirst(ps(igrid)%level,&
           2)+one)/dlog(qstretch(ps(igrid)%level,2)))-((node(pig2_,&
           igrid)-1+nstretchedblocks(level,&
           2)/2)*block_nx2-domain_nx2*2**(ps(igrid)%level-one))+nghostcells
      else
        ! possible non-stretched central part
  ...
  subroutine time_spent_on_particles()
    ...
    if (mype ==0) then
      ...
      write(*,'(a,f12.2,a)')'                  Percentage: ',&
         100.0d0*tpartc/(timeloop+smalldouble),' %'
      write(*,'(a,f12.3,a)')' Particle IO took           : ',tpartc_io_avg,&
         ' sec'
      write(*,'(a,f12.2,a)')'                  Percentage: ',&
         100.0d0*tpartc_io_avg/(timeloop+smalldouble),' %'
      write(*,'(a,f12.3,a)')' Particle COM took          : ',tpartc_com_avg,&
         ' sec'
      write(*,'(a,f12.2,a)')'                  Percentage: ',&
         100.0d0*tpartc_com_avg/(timeloop+smalldouble),' %'
      write(*,'(a,f12.3,a)')' Particle integration took  : ',tpartc_int_avg,&
         ' sec'
      write(*,'(a,f12.2,a)')'                  Percentage: ',&
         100.0d0*tpartc_int_avg/(timeloop+smalldouble),' %'
      write(*,'(a,f12.3,a)')' Particle init grid took    : ',tpartc_grid_avg,&
         ' sec'
      write(*,'(a,f12.2,a)')'                  Percentage: ',&
         100.0d0*tpartc_grid_avg/(timeloop+smalldouble),' %'
    end if
...
!    if (particle(index)%self%follow) print*, 'follow index:', index
  ...
  subroutine output_ensemble(send_n_particles_for_output,send_particles,&
    ...
    if (mype > 0) then
      ...
      if(typefile=='destroy') then ! Destroyed file
        ...
        write(filename,"(a,a,i6.6,a)") trim(base_filename) // '_',&
            trim(typefile) // '_', nint(send_particles(&
           1)%time/dtsave_particles),'.csv'
        open(unit=unitparticles,file=filename)
        write(unitparticles,"(a)") trim(csv_header)
      end if
  ...
  subroutine partvec_to_cartesian(xp,up,upcart)
    ...
    case (spherical)
      ...
      upcart(3) = up(1)*sin(xp(2))*sin(xp(3)) + up(2)*cos(xp(2))*sin(xp(3)) + &
         up(3)*cos(xp(3))
  ...
  subroutine partvec_from_cartesian(xp,up,upcart)
    ...
    case (spherical)
      ...
      up(1) = upcart(1)*sin(xp(2))*cos(xp(3)) + &
         upcart(3)*sin(xp(2))*sin(xp(3)) + upcart(2)*cos(xp(2)) 
      up(2) = upcart(1)*cos(xp(2))*cos(xp(3)) + &
         upcart(3)*cos(xp(2))*sin(xp(3)) - upcart(2)*sin(xp(2))
  ...
  logical function point_in_igrid_ghostc(x, igrid, ngh)
    ...
    grid_rmin      = [ rnode(rpxmin1_,igrid)-rnode(rpdx1_,&
       igrid)*(DBLE(nghostcells-ngh)-0.5d0),rnode(rpxmin2_,igrid)-rnode(rpdx2_,&
       igrid)*(DBLE(nghostcells-ngh)-0.5d0) ]
    grid_rmax      = [ rnode(rpxmax1_,igrid)+rnode(rpdx1_,&
       igrid)*(DBLE(nghostcells-ngh)-0.5d0),rnode(rpxmax2_,igrid)+rnode(rpdx2_,&
       igrid)*(DBLE(nghostcells-ngh)-0.5d0) ]
