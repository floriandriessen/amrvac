!> Jet setup, B field as in A&A 486, 663, 2008. 2.5D version
  ...
  subroutine specialbound_usr(qdt,qt,ixI^L,ixO^L,iB,w,x)
    ...
    case(3)
      ...
      do ix2 = ixOmin2,ixOmax2
         where(dabs(R(ixOmin1:ixOmax1,ix2)) > 1.0d0)
           ...
           w(ixOmin1:ixOmax1,ix2,mom(3))= w(ixOmin1:ixOmax1,2*ixOmax2-ix2+1,mom(3))
           w(ixOmin1:ixOmax1,ix2,e_)    = w(ixOmin1:ixOmax1,2*ixOmax2-ix2+1,e_)
           w(ixOmin1:ixOmax1,ix2,mag(1))=-w(ixOmin1:ixOmax1,2*ixOmax2-ix2+1,mag(1))
           w(ixOmin1:ixOmax1,ix2,mag(2))= w(ixOmin1:ixOmax1,2*ixOmax2-ix2+1,mag(2))
           w(ixOmin1:ixOmax1,ix2,mag(3))=-w(ixOmin1:ixOmax1,2*ixOmax2-ix2+1,mag(3))
         endwhere
      enddo
