...
contains
  ...
  case(1)
    ...
    do ix1=ixOmax1,ixOmin1,-1
      ...
      w(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,mag(1)) = two*x(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,1)*x(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,2) &
                                  /(x(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,1)**2+x(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,2)**2)**2
      w(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,mag(2)) = -one+ (x(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,2)**2-x(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,1)**2) &
                                        /(x(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,1)**2+x(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,2)**2)**2
      w(ix1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,mag(3)) = b3val
    enddo
  ...
  case(3)
    ...
    do ix2=ixOmax2,ixOmin2,-1
      ...
      w(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,mag(1)) = two*x(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,1)*x(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,2) &
                                  /(x(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,1)**2+x(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,2)**2)**2
      w(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,mag(2)) = -one+ (x(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,2)**2-x(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,1)**2) &
                                        /(x(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,1)**2+x(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,2)**2)**2
      w(ixOmin1:ixOmax1,ix2,ixOmin3:ixOmax3,mag(3)) = b3val
    enddo
    ! now reset the inner mesh values to conservative
    call eos%to_conserved(ixG^L,ixIM^L,w,x)
    call eos%to_conserved(ixG^L,ixO^L,w,x)
